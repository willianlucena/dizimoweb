                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="people"><g:message code="permissao.people.label" default="People" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: permissaoInstance, field: 'people', 'errors')}">
                                    <g:select name="people" from="${Usuario.list()}" multiple="yes" optionKey="id" size="5" value="${permissaoInstance?.people*.id}" />
                                </td>
                            </tr>
