...
<g:set var="entityName"
	value="${message(code: 'igreja.label', default: 'Igreja')}" />
...
<g:if test="${flash.message}">
...
</g:if> <g:hasErrors bean="${igrejaInstance}">
	<div class="errors"><g:renderErrors bean="${igrejaInstance}"
		as="list" /></div>
		...
		<tbody>
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="nome"><g:message
					code="igreja.nome.label" default="Nome da Igreja" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: igrejaInstance, field: 'nome', 'errors')}">
				<input type="text" name="nome" value="${igrejaInstance?.nome}" /></td>
			</tr>
			...
			<tr class="prop">
				...
				<input type="text" name="complemento"
					value="${enderecoInstance?.complemento}" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="pais"><g:message
					code="endereco.pais.label" default="Pais" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: enderecoInstance, field: 'pais', 'errors')}">
				<input type="text" name="pais" value="${enderecoInstance?.pais}" />
				</td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="numero"><g:message
					code="endereco.numero.label" default="Numero" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: enderecoInstance, field: 'numero', 'errors')}">
			...
			<tr class="prop">
				<td valign="top" class="name"><label for="cidade"><g:message
					code="endereco.cidade.label" default="Cidade" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: enderecoInstance, field: 'cidade', 'errors')}">
				<input type="text" name="cidade" value="${enderecoInstance?.cidade}" />
				</td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="cep"><g:message
					code="endereco.cep.label" default="Cep" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: enderecoInstance, field: 'cep', 'errors')}">
				<input type="text" name="cep" value="${enderecoInstance?.cep}" /></td>
			</tr>

			<tr class="prop">
				<td valign="top" class="name"><label for="estado"><g:message
					code="endereco.estado.label" default="Estado" /></label></td>
				<td valign="top"
					class="value ${hasErrors(bean: enderecoInstance, field: 'estado', 'errors')}">
			...
			<tr class="prop">
				...
				<input type="text" name="logradouro"
					value="${enderecoInstance?.logradouro}" /></td>
			</tr>
	...
	<div class="buttons"><span class="button"><g:submitButton
		name="create" class="save" value="Cadastrar" /></span></div>
</g:form></div>
</body>
</html>
