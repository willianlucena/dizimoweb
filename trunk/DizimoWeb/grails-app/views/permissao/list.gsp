                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="description" title="${message(code: 'permissao.description.label', default: 'Description')}" />
                    ...
                    <g:each in="${permissaoInstanceList}" status="i" var="permissaoInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: permissaoInstance, field: "authority")}</td>
                        
                            <td>${fieldValue(bean: permissaoInstance, field: "description")}</td>
